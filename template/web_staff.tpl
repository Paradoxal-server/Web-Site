    ...
    <div class="container">
            <div class="staff">
                ...
                <div class="staff-team">
                    <div>
                        <h3>Arisa02</h3>
                        <div class="owner">Fondateur</div>
                        <div class="dev_web">Développeur Web</div>
                        <div class="dev_java">Développeur Java</div>
                        <img src="https://crafatar.com/renders/body/{$val.skin.uuid1}">
                    </div>

                    <div>
                        <h3>Knight_Stardust</h3>
                        <div class="admin">Admin</div>
                        <img src="https://crafatar.com/renders/body/{$val.skin.uuid2}">
                    </div>
