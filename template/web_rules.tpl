...
<main role="main">
    ...
    <div class="container">
        <div class="staff">
                <h2>Régles du serveur</h2>
                <div class="staff-team">
                    <div class="card bg-dark text-white">
                        <div class="card-body">
                            <h4 class="card-title">Régles de base</h4>
                            <p class="card-text">1- Have Fun</p>
                        </div>
                        <div class="card-body">
                            <h4 class="card-title">Régles des metier</h4>
                            <p class="card-text">1- Respecter votre metier</p>
                            <p class="card-text">2- N'utiliser pas le metier d'autre joueur</p>
                            <p class="card-text">3- Les prix doit équilibrée</p>
                        </div>
                        <div class="card-body">
                            <h4 class="card-title">Régles Imorptant</h4>
                            <p class="card-text">1- Ecouter ce que le staff dit</p>
                            <p class="card-text">2- Evitez de faire lager le serveur</p>
                        </div>
                        <br>
                        <p class="card-text">En cas de probléme contactez un admin</p>
                    </div>
                </div>
        </div>
