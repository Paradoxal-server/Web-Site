<?php
    ...
    if(isset($_GET['page']))
    {
        if($_GET['page'] == "profils")
        {
            $var_index['title_page'] = "Modification du profils | " . $var_base['Title'];
            ...
            $userinfo = $DataBase->get_user_info_security($_SESSION['pseudo']);
            $var_index['infoPseudo'] = $userinfo;
           //$Debug->debug($var_index);
            $Smarty->assign("val", $var_index);

            try {
                $Smarty->display("profils.tpl");
